...
&ENDIF
&IF ENTRY(2, "A,B,C", ",;") EQ "B" &THEN
  DEFINE VARIABLE var68 AS CHARACTER.
&ENDIF
&IF ENTRY(2, "A,B,C", ";,") EQ "B" &THEN
  DEFINE VARIABLE var69 AS CHARACTER.
&ENDIF

&IF "abc" MATCHES "ab" + "c" &THEN
  DEFINE VARIABLE var70 AS CHARACTER.
&ENDIF
&IF NOT "abc" MATCHES "ab" + "c" &THEN
  DEFINE VARIABLE var71 AS CHARACTER.
&ENDIF
&IF "abc" MATCHES "ab" + "c" AND "abc" BEGINS "ab" + "c" &THEN
  DEFINE VARIABLE var72 AS CHARACTER.
&ENDIF
&IF "abc" MATCHES "ab" + "c" AND NOT "abc" BEGINS "ab" + "c" &THEN
  DEFINE VARIABLE var73 AS CHARACTER.
&ENDIF
&GLOBAL-DEFINE XXX abcxxxdef
&GLOBAL-DEFINE YYY xxx
&IF "{&XXX}" MATCHES "*" + SUBSTRING("{&yyy}", 1, 3) + "*" AND NOT "zzz{&XXX}" MATCHES SUBSTRING("{&YYY}", 1, 3) + "*" &THEN
  DEFINE VARIABLE var74 AS CHARACTER.
&ENDIF
...
&IF PROPATH BEGINS 'Resources' &THEN
...
&IF PROCESS-ARCHITECTURE EQ 32 &THEN
 DEF VAR var78 AS CHAR.
&ENDIF
&IF PROCESS-ARCHITECTURE EQ 64 &THEN
 DEF VAR var79 AS CHAR.
&ENDIF